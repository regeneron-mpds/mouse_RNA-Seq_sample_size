...
for (this.type in c("")) { # , "_uponly")) {
  ...
  saveRDS(prob_correct, paste0('result_objs/Dchs1_prob_correct', this.type, '_GSFC', goldstandard.FC, '_minSignif', MIN_NUM_SIGNIF, '.RDS'))
  saveRDS(prob_detect, paste0('result_objs/Dchs1_prob_detect', this.type, '_GSFC', goldstandard.FC, '_minSignif', MIN_NUM_SIGNIF, '.RDS'))
  saveRDS(prob_detect_cumul, paste0('result_objs/Dchs1_prob_detect_cumul', this.type, '_GSFC', goldstandard.FC, '_minSignif', MIN_NUM_SIGNIF, '.RDS'))
}
